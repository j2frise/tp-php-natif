...
?>
<form class="form-signin" id="common-form" action="/login" method="POST">
  ...
  <div class="form-label-group mt-4 message">
  ...
  <button class="btn btn-lg btn-primary btn-block form-button" type="submit">Se connecter</button>
